 ...
 * Provides commands like python:functions, python:model, python:tools, python:barrel.
 */
...
const pythonPlugin: Plugin = {
  descriptor: {
    ...
    version: '0.1.0',
    namespaceDescription: 'Python codegen (functions, model, tools, barrel)',
  },
  commands: [barrelCommand, functionsCommand, modelCommand, toolsCommand],
  renderers: [],
};
